<?
//notifies the user that they have successfully posted a listing
session_start();
			...
			<div class="12u">
				<section>
					<div class="post" align = "center">
						<h2>Success</h2>
                       Listing successfully created! <br /> <a href = 'account' class='darker'>Click here</a> to go to your accounts page or <a href = 'sell' class='darker'>Click here</a> to sell another book.
