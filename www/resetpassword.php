<?php
/*
This form prompts the user to enter their email and the temporary
password they recieved via email to be able to change their password.
*/
session_start();
			...
			<div class="12u">
				<section>
					<div class="post" align = "center">
						...
						Enter your email and the temporary password you recieved in your email
<br><br><br> 
...
<tr><td>Temporary Password &nbsp;&nbsp;&nbsp; </td><td><input type = "password" maxlength = "32" name = "password" /><br><br></td></tr>
</table>
